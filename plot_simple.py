...
if __name__ == "__main__":
    ...
    base = 'results/five_workers_iid_three_cls_iterative/'
    ...
    cloud_iid_3_cls = base + 'cloud.csv'
    # cloud_iid_3_cls_ten = 'results/ten_workers_iid_three_cls/distill_concat_2021-09-21-17-51.csv'

    edge_0_3_cls = base + 'acc_worker_0.csv'
    edge_1_3_cls = base + 'acc_worker_1.csv'
    edge_2_3_cls = base + 'acc_worker_2.csv'
    edge_3_3_cls = base + 'acc_worker_3.csv'
    edge_4_3_cls = base + 'acc_worker_4.csv'
    ...
    plot(data_to_plot, 'Iteration', 'Top-1 test accuracy', '', output=base + 'iid_iterative_cloud.png')
