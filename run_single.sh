...
CUDA_VISIBLE_DEVICES=1 python3 single_model_test.py --net res6 --dataset cifar10 --workspace testtensorboard --lr_sched None --epoch 10 --percent_data 1
...
################ Distillation test ################
# CUDA_VISIBLE_DEVICES=0 python3 single_model_distill.py --net res6 --dataset cifar10 --workspace distill_speedtest --cloud_epoch 10
