...
def resnet10_pytorch(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
    r"""ResNet-10 model
    Args:
    """
...
def resnet18_pytorch(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet:
