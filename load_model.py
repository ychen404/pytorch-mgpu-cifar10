...
if args.net == 'res4':
    edge_net = resnet4(num_classes=100)
elif args.net == 'res8':
    edge_net = resnet8(num_classes=100)
elif args.net == 'res6':
    edge_net = resnet6(num_classes=100)
elif args.net =='res18':
    edge_net = resnet18(num_classes=100)
elif args.net =='res34':
    edge_net = resnet34(num_classes=100)
